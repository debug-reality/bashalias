...
# Podman
alias po='podman'
alias pob='podman build'
alias pobt='podman build -t'
alias pot='podman tag'
alias por='podman run'
alias pornm='podman run --name'
alias porde='podman run --detach'
alias pordenm='podman run --detach --name'
alias poimgs='podman images'
alias pormi='podman rmi'
alias porm='podman rm'
alias pops='podman ps'
alias popsa='podman ps -a'
alias popush='podman push'
alias popull='podman pull'
