...
alias kccjdry='k create cronjob --dry-run=client -o yaml'
alias kccjdryns='k create cronjob --dry-run=client -o yaml -n'
...
alias kgpow='k get pod -o wide'
alias kgpns='k get pod -n'
alias kgpnsow='k get pod -o wide -n'
...
alias kgnslb='kgnslb_f() { k get ns "$@" -o yaml | yq e ".metadata.labels" -; }; kgnslb_f'
# Label
alias klb='k label'
...
alias kgnsan='kgnsan_f() { k get ns "$@" -o yaml | yq e ".metadata.annotations" -; }; kgnsan_f'
# Annotation
...
alias klfns='k logs --all-containers --ignore-errors -f -n'
